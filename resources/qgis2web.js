...
map.getView().fit([575566.872108, 6722833.244189, 575797.603155, 6722958.940907], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Locatie keuze kanoverenigng Oisterwijk bouwvlakken</h2>';
        return titleElement;
    })(),
