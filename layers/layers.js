...
var format_SPORTbpSporkpparkdenDonkmax5bebouwd_3 = new ol.format.GeoJSON();
var features_SPORTbpSporkpparkdenDonkmax5bebouwd_3 = format_SPORTbpSporkpparkdenDonkmax5bebouwd_3.readFeatures(json_SPORTbpSporkpparkdenDonkmax5bebouwd_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SPORTbpSporkpparkdenDonkmax5bebouwd_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SPORTbpSporkpparkdenDonkmax5bebouwd_3.addFeatures(features_SPORTbpSporkpparkdenDonkmax5bebouwd_3);
var lyr_SPORTbpSporkpparkdenDonkmax5bebouwd_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_SPORTbpSporkpparkdenDonkmax5bebouwd_3, 
                style: style_SPORTbpSporkpparkdenDonkmax5bebouwd_3,
                popuplayertitle: 'SPORT bp Sporkppark den Donk (max. 5% bebouwd)',
                interactive: false,
                title: '<img src="styles/legend/SPORTbpSporkpparkdenDonkmax5bebouwd_3.png" /> SPORT bp Sporkppark den Donk (max. 5% bebouwd)'
            });
...
lyr_Googlesatelite_0.setVisible(true);lyr_OpenStreetMap_1.setVisible(true);lyr_GROENbpSportparkDenDonk_2.setVisible(false);lyr_SPORTbpSporkpparkdenDonkmax5bebouwd_3.setVisible(false);lyr_ZonekwaliteitsverbeteringlandschapbpSportparkDenDonk_4.setVisible(false);lyr_EcologischeverbindingszonedbDenDonk_5.setVisible(false);lyr_Recreatiefunctievolkstuinenbpwoongebieden_6.setVisible(false);lyr_Tuinbpbuitengebied_7.setVisible(false);lyr_KadastraleKaart_8.setVisible(true);lyr_Mogelijkebouwvlakkenkanoverenigngcirca260m2_9.setVisible(true);lyr_hulplijnen_10.setVisible(true);
var layersList = [lyr_Googlesatelite_0,lyr_OpenStreetMap_1,lyr_GROENbpSportparkDenDonk_2,lyr_SPORTbpSporkpparkdenDonkmax5bebouwd_3,lyr_ZonekwaliteitsverbeteringlandschapbpSportparkDenDonk_4,lyr_EcologischeverbindingszonedbDenDonk_5,lyr_Recreatiefunctievolkstuinenbpwoongebieden_6,lyr_Tuinbpbuitengebied_7,lyr_KadastraleKaart_8,lyr_Mogelijkebouwvlakkenkanoverenigngcirca260m2_9,lyr_hulplijnen_10];
lyr_GROENbpSportparkDenDonk_2.set('fieldAliases', {'fid': 'fid', });
lyr_SPORTbpSporkpparkdenDonkmax5bebouwd_3.set('fieldAliases', {'fid': 'fid', 'gml_id': 'gml_id', 'namespace': 'namespace', 'lokaalID': 'lokaalID', 'typePlanobject': 'typePlanobject', 'naam': 'naam', 'symboolCode': 'symboolCode', 'waarde': 'waarde', 'waardeType': 'waardeType', 'maatvoeringInfo|WaardeEnType|symboolCode': 'maatvoeringInfo|WaardeEnType|symboolCode', });
...
lyr_SPORTbpSporkpparkdenDonkmax5bebouwd_3.set('fieldImages', {'fid': 'TextEdit', 'gml_id': 'TextEdit', 'namespace': 'TextEdit', 'lokaalID': 'TextEdit', 'typePlanobject': 'TextEdit', 'naam': 'TextEdit', 'symboolCode': 'TextEdit', 'waarde': 'TextEdit', 'waardeType': 'TextEdit', 'maatvoeringInfo|WaardeEnType|symboolCode': 'TextEdit', });
...
lyr_SPORTbpSporkpparkdenDonkmax5bebouwd_3.set('fieldLabels', {'fid': 'no label', 'gml_id': 'no label', 'namespace': 'no label', 'lokaalID': 'no label', 'typePlanobject': 'no label', 'naam': 'no label', 'symboolCode': 'no label', 'waarde': 'no label', 'waardeType': 'no label', 'maatvoeringInfo|WaardeEnType|symboolCode': 'no label', });
